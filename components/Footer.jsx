		...
		<div className="flex justify-center items-center flex-col mt-5 overflow-hidden">
			<div className="flex justify-center items-center flex-col mt-5 self-center min-h-[50vh] border-b-2 border-gradient-to-r from-black to-[#0f8fd4] min-w-[80vw] ">
				<Link href="/#contact">
					...
					<motion.h1
						className="text-5xl md:text-7xl font-medium mt-3 bg-gradient-to-r from-black to-[#0f8fd4] bg-clip-text text-transparent hover:from-[#0f8fd4] hover:to-black transition-all duration-500 whitespace-nowrap leading-none"
						initial={{
							opacity: 0,
							x: 100,
						}}
						...
						<FontAwesomeIcon
							...
							className="text-5xl ml-2 text-[#0f8fd4]"
						/>
					</motion.h1>
				</Link>
			</div>
			<footer className="flex justify-center items-center flex-col my-5 self-start]">
				<p className="text-gray-800 text-sm">
					...
					<span className="bg-gradient-to-r from-black to-[#0f8fd4] bg-clip-text text-transparent text-lg font-medium">
						WebVisionAgency
					</span>
				</p>
			</footer>
