...
// images
import Intervyou1 from "@/public/image/projects/web/portfolio/ichaoui1.png";
import Intervyou2 from "@/public/image/projects/web/portfolio/ichaoui2.png";
import Intervyou3 from "@/public/image/projects/web/portfolio/ichaoui3.png";
        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-justify title text-lg">
              My Portfolio is a personal website I built to present my
              education, skills, and projects in web development and AI. It is
              developed with Next.js, TypeScript, Tailwind CSS, Shadcn UI,
              Prisma, and MySQL (TiDB) to ensure scalability, performance, and a
              clean design. The website includes sections such as About Me,
              Education, Skills, Projects, and Contact, allowing visitors to
              explore my professional background and technical expertise. It
